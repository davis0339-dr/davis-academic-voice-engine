...
export const DEEP_AUTHORIAL_PROTOCOL = Object.freeze([
    ...
    "DIAGNOSED MACHINE POLISH IS NOT AUTHORIAL EVIDENCE: grammatical fluency, orderly paragraphs and sophisticated vocabulary do not justify KEEP when machine-language, discourse-regularity, candidate-linked feedback or an assigned human-discourse operation identifies the passage for reconstruction. In that scope, rebuild from the research ledger instead of protecting the sentence shell.",
