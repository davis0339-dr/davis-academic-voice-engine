...
const choppySource = `The older view was narrow and compliance-led. Financial markets deepened. Accountability expectations widened. A broader conception of performance then emerged, combining revenue, competitive position, technical quality and engagement efficiency within the same analytical frame. This development also reflected the profession's movement toward knowledge-intensive and technology-enabled work rather than statutory compliance alone.`;

const choppyStillThere = `The earlier view remained narrow and compliance-led. Markets deepened. Expectations widened. A broader understanding of performance then emerged, combining revenue, competitive position, technical quality and engagement efficiency within one analytical frame. The change also reflected the profession's movement toward knowledge-intensive and technology-enabled work rather than statutory compliance alone.`;
